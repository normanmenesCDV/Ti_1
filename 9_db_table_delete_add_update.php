...
<table>
	...
	if ($result->num_rows == 0){
      ...
      <tr>
        ...
        <td>$user[city]</td>
        <td>$user[state]</td>
        <td><a href="./scripts/db/delete_user.php?userDeleteId=$user[userId]">Usuń</a></td>
        <td><a href="./9_db_table_delete_add_update.php?userUpdateId=$user[userId]">Edytuj</a></td>
      </tr>
TABLEUSERS;
		}
	}
 ...
 //formularz dodawania użytkownika
  if (isset($_GET["showFormAddUser"])){
    ...
    echo <<< ADDUSERFORM
      <form action="./scripts/db/addUser.php" method="POST">
...
ADDUSERFORM;
    ...
    echo '<a href="./9_db_table_delete_add_update.php?showFormAddUser=1">Dodaj użytkownika</a>';
  }
    ...
    //echo $updateUser["firstName"];
		echo <<< UPDATEUSERFORM
      <form action="./scripts/db/updateUser.php" method="POST">
