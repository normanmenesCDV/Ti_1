...
--
-- Host: 127.0.0.1
-- Czas generowania: 13 Mar 2023, 10:35
...
--
CREATE DATABASE IF NOT EXISTS `db_nmenes_ti` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `db_nmenes_ti`;
...
(1, 'Agnieszka', 'Garczyńska', '0000-00-00'),
(2, 'Tadeusz', 'Nowak', '0000-00-00'),
(3, 'Agnieszka', 'Garczyńska', '2023-03-08'),
(4, 'Tadeusz', 'Nowak', '2023-03-01'),
(5, 'Marzena', 'Łajs', '2023-03-03'),
(6, 'Tomek', 'Piękny', '2023-03-07');
...
('root', '[{\"db\":\"db_nmenes_ti\",\"table\":\"users\"}]');
...
('root', '2023-03-13 08:46:41', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\",\"DefaultConnectionCollation\":\"utf8_general_ci\"}');
